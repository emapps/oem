...
function WebChatbotListener() {
	...
	this.createBox = function() {
		...
		html = html
			...
			+ "<table>\n"
			+ "<tr class='" + this.prefix + "menuitem'>"
				+ "<td><a class='" + this.prefix + "menuitem' href='#'><img class='" + this.prefix + "menu' src='" + urlprefix + "images/language.png' title='Translate to and from your selected language'>"
		...
		if (this.allowSpeech) {
			html = html
				+ "<tr class='" + this.prefix + "menuitem'>"
					+ "<td><a id='" + this.prefix + "boxspeakmenu' class='" + this.prefix + "menuitem' href='#'><img id='" + this.prefix + "boxspeak2' class='" + this.prefix + "menu' src='" + urlprefix + (this.speak ? "images/sound.png": "images/mute.png") +"' title='Speech'> Speech</a></td>"
				+ "</tr>\n";
			if (SDK.isChrome()) {
				html = html
					+ "<tr class='" + this.prefix + "menuitem'>"
		...
		if (this.allowSpeech) {
			html = html
				+ "<a href='#' title='Speech'><img id='" + this.prefix + "boxspeak' class='" + this.prefix + "boxbutton' src='"
								+ urlprefix
								+ (this.speak ? "images/sound.png": "images/mute.png") +"'></a></td>"
					+ (SDK.isChrome() ?
							("<a href='#' title='Speech Recognition'><img id='" + this.prefix + "boxspeakrecognition' class='" + this.prefix + "boxbutton' src='"
									+ urlprefix
									+ "images/micoff.png'></a>")
							: "");
		}
